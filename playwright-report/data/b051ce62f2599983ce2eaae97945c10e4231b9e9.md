...
- Name: editor.spec.js >> Interface do Editor Taurus >> deve alternar a IA e mostrar o status
- Location: tests\e2e\editor.spec.js:44:3
...
Call log:
  - waiting for locator('#ai-toggle-switch')
    - locator resolved to <input type="checkbox" class="sr-only peer" id="ai-toggle-switch"/>
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    - generic [ref=e3]:
      - generic [ref=e4]:
        - button "Novo Documento (Alt+N)" [ref=e5]
